...
const AboutPage = () => {
  const founders = [
      ...
      image: 'https://media.discordapp.net/attachments/1095026684165627914/1409203413278916702/1790f0ca21d98b1bef40e14d95ecd10d.webp?ex=68ac8673&is=68ab34f3&hm=7fb7a1627d36261185ce1cb2ca4889375a41ed22df352697aa41fd1e166bef96&=&format=webp&width=741&height=844'
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Learn about Gen Uprising's mission to educate, question, and empower young citizens worldwide through civic literacy and authentic youth perspectives." />
        <meta property="og:title" content="About Us - Gen Uprising" />
        <meta property="og:description" content="Learn about Gen Uprising's mission to educate, question, and empower young citizens worldwide through civic literacy and authentic youth perspectives." />
      </Helmet>
            ...
            >
              ...
              <div className="pull-quote">
                ...
                <p className="text-sm text-[var(--text-muted)]">
                  "What if we created the political education resource we wished we'd had in high school? What if we proved that young people could engage with complex political issues with the same rigor as any academic journal, but with the accessibility and energy that our generation brings to everything we do?"
                </p>
                <p className="text-xs text-[var(--text-muted)] mt-2 italic">
                  — From the original Gen Uprising manifesto, written collaboratively over three time zones
                </p>
              </div>

              <p className="text-lg leading-relaxed mb-6">
                The idea was simple but revolutionary: create a platform that treated young people as serious political actors while maintaining the educational rigor of the best civic textbooks. We wanted to prove that accessibility didn't mean dumbing down, and that youth perspectives weren't just valid—they were essential.
              </p>
                ...
                >
                  <div className="mb-6">
                    <img  
                      ...
                      alt={`Portrait of $Roopkatha Dey`}
                     src="https://media.discordapp.net/attachments/1095026684165627914/1409203413278916702/1790f0ca21d98b1bef40e14d95ecd10d.webp?ex=68ac8673&is=68ab34f3&hm=7fb7a1627d36261185ce1cb2ca4889375a41ed22df352697aa41fd1e166bef96&=&format=webp&width=741&height=844" />
                  </div>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {values.map((value, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div>
                      <h3 className="text-xl font-bold serif text-[var(--navy)] mb-2">{value.title}</h3>
                      <p className="text-[var(--text-muted)] leading-relaxed">{value.description}</p>
                    </div>
                  </motion.div>
                );
              })}
              ...
              <div className="footnote text-gray-400 border-gray-600">
              </div>
            </motion.div>
          </div>
        </section>
